...
@ResponseStatus(code= HttpStatus.BAD_REQUEST,reason="user.group.code.already.occupied")
public class UserGroupCodeAlreadyOccupiedException extends RuntimeException {
