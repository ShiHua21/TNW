...
public class JooqPostMemberRepository extends AbstractJooqRepository<PostMember,PostMemberRecord> implements PostMemberRepository {
    ...
    @Override
    public PostMember delete(Integer id) {
        ...
        int deletedRecordCount = jooq.delete(com.jic.tnw.db.mysql.tables.PostMember.POST_MEMBER)
                .where(com.jic.tnw.db.mysql.tables.PostMember.POST_MEMBER.USER_ID.equal(id))
                .execute();
    ...
    @Override
    public PostMember findById(Integer id) {
        PostMemberRecord queryResult = jooq.selectFrom(com.jic.tnw.db.mysql.tables.PostMember.POST_MEMBER).where(com.jic.tnw.db.mysql.tables.PostMember.POST_MEMBER.ID.eq(id))
                .fetchOne();
    ...
    private PostMemberRecord createRecord(PostMember entry) {
        ...
        postMemberRecord.setPostId(entry.getPostId());
