...
@ResponseStatus(code= HttpStatus.BAD_REQUEST,reason="course.category.code.already.occupied")
public class CategoryCodeAlreadyOccupiedException extends RuntimeException {
